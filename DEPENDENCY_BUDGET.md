...
Hosted accepted build: Standard 39,313,910 bytes installed and 17,392,256-byte ZIP (46.9% of its 80 MiB budget); Pro 40,165,878 bytes and 17,747,557-byte ZIP (29.5% of 130 MiB). Both packages intentionally report the shared engine rather than hiding it. Android arm64 release is 18,907,513 bytes, only 1,476 bytes above baseline; PDFium is not packaged into Mobile. Packaged Pro parse/text/render smoke returned 0.
